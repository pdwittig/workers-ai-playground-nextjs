// .wrangler/tmp/bundle-F99dO2/checked-fetch.js
...
// .wrangler/tmp/pages-sWmmJX/bundledWorker-0.6330655454718257.mjs
...
async function C(e, { request: t, assetsFetcher: r, ctx: s }, { path: a, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        n = b(await r.fetch(H(c, e.path ?? a))), e.headers && R(n.headers, e.headers);
        break;
      }
      case "static": {
        n = await r.fetch(H(c, a));
        break;
      }
      default:
...
var k = class {
  ...
  applyRouteDest(t, r, s) {
    ...
    return x(this.searchParams, A.searchParams), P(this.path) || (this.path = A.pathname), a;
  }
...
// .wrangler/tmp/pages-sWmmJX/l1g5kkq35fa.js
...
// .wrangler/tmp/bundle-F99dO2/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-F99dO2/middleware-loader.entry.ts
