...
function N(e, { url: t, cookies: r, headers: s, routeDest: a }) {
  switch (e.type) {
    case "host":
...
var k = class {
  ...
  checkRouteMatch(t, { checkStatus: r, checkIntercept: s }) {
    ...
    }) && !t.missing?.find((n) => N(n, i).valid) && !(r && t.status !== this.status)) {
      if (s && t.dest) {
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.12606062377814564.mjs.map
