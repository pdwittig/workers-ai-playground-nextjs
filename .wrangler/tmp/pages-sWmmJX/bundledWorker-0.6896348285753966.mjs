...
async function C(e, { request: t, assetsFetcher: r, ctx: s }, { path: a, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        n = b(await r.fetch(U(c, e.path ?? a))), e.headers && R(n.headers, e.headers);
        break;
      }
      case "static": {
        n = await r.fetch(U(c, a));
        break;
      }
      default:
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.6896348285753966.mjs.map
