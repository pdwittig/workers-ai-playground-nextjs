...
var ie = (e, t, r, s) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let a of re(t))
      !ne.call(e, a) && a !== r && H(e, a, { get: () => t[a], enumerable: !(s = se(t, a)) || s.enumerable });
  return e;
};
var j = (e, t, r) => (r = e != null ? te(ae(e)) : {}, ie(t || !e || !e.__esModule ? H(r, "default", { value: e, enumerable: true }) : r, e));
var g;
var l = T(() => {
  g = { collectedLocales: [] };
});
...
var k = class {
  ...
  applyRouteDest(t, r, s) {
    ...
    return x(this.searchParams, V.searchParams), P(this.path) || (this.path = V.pathname), a;
  }
  ...
  async checkPhase(t) {
    ...
    let a = "miss";
    return s || t === "miss" || t === "error" ? a = "hit" : r && (a = L(t)), this.checkPhase(a);
  }
  async run(t = "none") {
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.5769310465400588.mjs.map
