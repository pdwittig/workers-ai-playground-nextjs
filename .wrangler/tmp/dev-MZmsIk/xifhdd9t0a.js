// .wrangler/tmp/bundle-QnQ1FC/checked-fetch.js
...
// .wrangler/tmp/pages-v4IakX/bundledWorker-0.4321165352320715.mjs
...
var ie = (e, t, r, s) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let a of re(t))
      !ne.call(e, a) && a !== r && L(e, a, { get: () => t[a], enumerable: !(s = se(t, a)) || s.enumerable });
  return e;
};
var j = (e, t, r) => (r = e != null ? te(ae(e)) : {}, ie(t || !e || !e.__esModule ? L(r, "default", { value: e, enumerable: true }) : r, e));
var g;
var l = T(() => {
  g = { collectedLocales: [] };
});
...
var k = class {
  ...
  applyRouteDest(t, r, s) {
    ...
    return x(this.searchParams, H.searchParams), P(this.path) || (this.path = H.pathname), a;
  }
...
// .wrangler/tmp/pages-v4IakX/xifhdd9t0a.js
...
// .wrangler/tmp/bundle-QnQ1FC/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-QnQ1FC/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=xifhdd9t0a.js.map
