// .wrangler/tmp/bundle-nug6yI/checked-fetch.js
...
// .wrangler/tmp/pages-MbRX2j/bundledWorker-0.38073557068635155.mjs
...
async function C(e, { request: t, assetsFetcher: r, ctx: s }, { path: a, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        n = b(await r.fetch(L(c, e.path ?? a))), e.headers && R(n.headers, e.headers);
        break;
      }
      case "static": {
...
// .wrangler/tmp/pages-MbRX2j/r4ey835ra2h.js
...
// .wrangler/tmp/bundle-nug6yI/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-nug6yI/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=r4ey835ra2h.js.map
