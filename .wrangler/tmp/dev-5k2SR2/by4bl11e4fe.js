// .wrangler/tmp/bundle-VW5Ztn/checked-fetch.js
...
// .wrangler/tmp/pages-LHXY2O/bundledWorker-0.001314796088446979.mjs
...
async function C(e, { request: t, assetsFetcher: r, ctx: s }, { path: a, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        n = b(await r.fetch(A(c, e.path ?? a))), e.headers && R(n.headers, e.headers);
        break;
      }
      case "static": {
...
var k = class {
  ...
  async checkPhase(t) {
    ...
    let a = "miss";
    return s || t === "miss" || t === "error" ? a = "hit" : r && (a = I(t)), this.checkPhase(a);
  }
  async run(t = "none") {
...
// .wrangler/tmp/pages-LHXY2O/by4bl11e4fe.js
...
// .wrangler/tmp/bundle-VW5Ztn/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-VW5Ztn/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=by4bl11e4fe.js.map
