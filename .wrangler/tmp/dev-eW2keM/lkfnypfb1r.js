// .wrangler/tmp/bundle-Mt1nB5/checked-fetch.js
...
// .wrangler/tmp/pages-SlfAJe/bundledWorker-0.39497646454286506.mjs
...
var k = class {
  ...
  processMiddlewareResp(t) {
    ...
    if (i) {
      ...
      this.path = u ? `${c}` : c.pathname, w(this.searchParams, c.searchParams), t.headers.delete(a);
    }
  ...
  applyRouteDest(t, r, s) {
    ...
    return w(this.searchParams, U.searchParams), P(this.path) || (this.path = U.pathname), a;
  }
...
// .wrangler/tmp/pages-SlfAJe/lkfnypfb1r.js
...
// .wrangler/tmp/bundle-Mt1nB5/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Mt1nB5/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=lkfnypfb1r.js.map
